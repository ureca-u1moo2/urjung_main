...
public enum Topic {
    ...
    RECOMMENDATION_PLAN("사용자에게 적합한 요금제를 추천해달라는 요청입니다. 예: '추천해줘', '내게 맞는 요금제는 뭐야?'"),
    ...
    FILTERED_PLAN_LIST("전체 요금제 중 특정 조건(무제한, 5G, 저가 등)을 만족하는 요금제만 보여달라는 요청입니다. 예: '무제한 요금제 뭐 있어?', '5G 요금제만 알려줘'"),
    ETC("요금제나 서비스와 관련 없는 기타 질문입니다. 예: '오늘 날씨 어때?', 'AI는 똑똑하네', '심심해'");
